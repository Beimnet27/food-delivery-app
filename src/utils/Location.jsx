...
export const getNavigationLink = (currentLocation, customerLat, customerLng) => {
  if (!currentLocation || !customerLat || !customerLng) return "#"; // Prevent invalid URLs

  return `https://www.google.com/maps/dir/?api=1&origin=${currentLocation.lat},${currentLocation.lng}&destination=${customerLat},${customerLng}`;
};
